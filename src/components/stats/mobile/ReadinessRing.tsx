  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        <span className="text-[11px] uppercase tracking-[0.18em]" style={{ color: TELEMETRY.muted }}>
          Readiness
        </span>
        <span
        ...
        >
          ...
          <span className="text-xl align-top ml-0.5" style={{ color: TELEMETRY.muted }}>%</span>
        </span>
